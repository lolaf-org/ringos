...
public class UnsafeSpScRingBuffer<T> extends AbstractSpScRingBuffer<T> {
    ...
    public UnsafeSpScRingBuffer(int capacity, boolean bufferPaddingEnabled, IntFunction<T> elementInstanceProducer) {
