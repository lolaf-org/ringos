...
/**
 * A timer task that accepts two arguments, analogous to
 * {@link org.lolaf.ringos.rb.RingBuffer.EventTranslatorTwoArg} for ring buffer offers.
 ...
 */
@FunctionalInterface
public interface TimerTaskTwoArg<A, B> {
