...
public class J11UnsafeSpMcRingBuffer<T> extends AbstractMpMcRingBuffer<T> {
    ...
    public J11UnsafeSpMcRingBuffer(int capacity, boolean bufferPaddingEnabled, IntFunction<T> elementInstanceProducer) {
