...
public class UnsafePooledMpScRingBuffer<T> extends AbstractMpMcRingBuffer<T> {
    ...
    public UnsafePooledMpScRingBuffer(int capacity, boolean bufferPaddingEnabled, IntFunction<T> elementInstanceProducer) {
